...
Puerto: 3005
Base de datos: pagos_db (MySQL puerto 3311)
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-pagos-key-dev-only')
...
# Media files (Uploads - PDFs de boletas)
MEDIA_URL = '/media/'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_FILTER_BACKENDS': [
        # 'django_filters.rest_framework.DjangoFilterBackend',  # Comentado temporalmente
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API REST para gestión de pagos, planillas y boletas del Sistema Pontificia',
    'VERSION': '1.0.0',
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'pagos_service.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
...
PAGOS_CONFIG = {
    'DESCUENTO_MAXIMO_PORCENTAJE': 30.0,  # Máximo 30% de descuento
    'ADELANTO_MAXIMO_PORCENTAJE': 50.0,   # Máximo 50% de adelanto
